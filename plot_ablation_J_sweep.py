...
DATA = {
    "r12": [
        {"fid": 76.16, "miou": 37.00, "dep": 0.8182},  # J=3
        {"fid": 75.72, "miou": 43.50, "dep": 0.8394},  # J=4
        {"fid": 83.60, "miou": 44.81, "dep": 0.8468},  # J=5
        {"fid": 89.61, "miou": 47.22, "dep": 0.8637},  # no drop_ll (baseline r12)
    ],
    "r16": [
        {"fid": 76.02, "miou": 38.73, "dep": 0.8383},  # J=3
        {"fid": 77.80, "miou": 44.31, "dep": 0.8512},  # J=4
        {"fid": 87.03, "miou": 45.84, "dep": 0.8554},  # J=5
        {"fid": 90.85, "miou": 48.28, "dep": 0.8693},  # no drop_ll (baseline r16)
    ],
}

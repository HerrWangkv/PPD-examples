"""
Calculate NeuralRemaster Appearance Score (AS) for SURREAL sim2real experiments.
...
NEGATIVE_PROMPTS = [
    "CGI rendering",
    "3D rendered human body",
    "Synthetic SMPL model",
    "Flat computer graphics lighting",
    "Plastic-like artificial skin",
]

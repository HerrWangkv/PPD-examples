...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "DNAEdit"))
...
def parse_args():
    parser = argparse.ArgumentParser(description="Batch image sim2real using DNAEdit + FLUX")
    ...
    parser.add_argument("--T_start", type=int, default=4)
    ...
    parser.add_argument("--mvg", type=float, default=0.85)

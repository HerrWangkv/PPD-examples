CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch --multi_gpu --num_processes 4 examples/flux/model_training/train.py \
  --max_pixels 2073600 \
  --dataset_repeat 1 \
  ...
  --output_path "./models/train/FLUX.1-dev_lora_wpd_dropll" \
  --lora_base_model "dit" \
  --lora_target_modules "a_to_qkv,b_to_qkv,ff_a.0,ff_a.2,ff_b.0,ff_b.2,a_to_out,b_to_out,proj_out,norm.linear,norm1_a.linear,norm1_b.linear,to_qkv_mlp" \
  --lora_rank 32 \
  --lora_checkpoint "./flux.safetensors" \

...
- **v6 implementation (DinoPD-v6, 2026-04-24)**:
  ...
  - **TODO**: rerun `validate_dino_trajectory.py` on v4 step-1000 under patch-only metric to establish apples-to-apples baseline. Current v4 baseline (0.62) was measured under the old 0.5·cls+0.5·patch mix.
